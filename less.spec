...
Version  : 581.2
Release  : 35
URL      : http://www.greenwoodsoftware.com/less/less-581.2.tar.gz
Source0  : http://www.greenwoodsoftware.com/less/less-581.2.tar.gz
...
%prep
%setup -q -n less-581.2
cd %{_builddir}/less-581.2
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1619634832
...
cp %{_builddir}/less-581.2/COPYING %{buildroot}/usr/share/package-licenses/less/8624bcdae55baeef00cd11d5dfcfa60f68710a02
cp %{_builddir}/less-581.2/LICENSE %{buildroot}/usr/share/package-licenses/less/0319a1deb4e0dea715d8210caf27c2ae6795ebeb
%make_install
